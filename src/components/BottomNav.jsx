...
import { IconHome, IconCar, IconGavel, IconHeart } from './Icons';

const items = [
  { id: 'home', path: '/', label: 'Inicio', Icon: IconHome },
  { id: 'catalogo', path: '/catalogo', label: 'Catálogo', Icon: IconCar },
  { id: 'subastas', path: '/subastas', label: 'Subastas', Icon: IconGavel },
          ...
          return (
            ...
            >
              <span style={{ position: 'relative' }}>
                <Icon size={22} sw={active ? 2 : 1.6} filled={id === 'favoritos' && active} />
              ...
              <span style={{ fontSize: 10.5, fontWeight: active ? 650 : 500, letterSpacing: '.01em' }}>{label}</span>
            </button>
          );
        })}
      </nav>
